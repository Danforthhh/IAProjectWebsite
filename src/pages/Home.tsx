        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {[
              ...
              <div key={s.label} className="bg-stone-50 rounded-2xl p-4 border border-stone-100 text-center">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={p.initials} className={`rounded-2xl p-4 border-2 ${p.highlight ? 'border-brand-400 bg-brand-50' : 'border-stone-100 bg-stone-50'}`}>
